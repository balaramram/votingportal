...
const Register = () => {
  ...
  try {
    ...
    const res = await fetch(`https://votingportal-tv3f.onrender.com/api/user/register`, {
      method: "POST", 
...
const handleSendOTP = async () => {
  ...
  setLoading(true);
  try {
    const res = await fetch('https://votingportal-tv3f.onrender.com/api/send-otp', {
      method: 'POST',
      headers: { 'Content-Type': 'application/json' },
...
const handleVerifyOTP = async () => {
  try {
    const res = await fetch('https://votingportal-tv3f.onrender.com/api/verify-otp', {
      method: 'POST',
      headers: { 'Content-Type': 'application/json' },
